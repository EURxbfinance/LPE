...
module.exports = function (deployer, network) {
  ...
  deployer.then(async () => {
    if (network === 'test' || network === 'soliditycoverage') {
      ...
      const usdtPoolAddress = await uniswapFactory.getPair.call(xbeAddress, usdtAddress);
      // deploy router
      ...
      await xbe.transfer(incentivizer.address, xbeReward);
      await incentivizer.notifyRewardAmount(xbeReward);
